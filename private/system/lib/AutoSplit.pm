# This is patched version of the original AutoSplit.pm 1.06.
#
# History:
#		==> 04.12.2008: fixed filepath in *.al files ("autosplit into <path>").
# 			Comments: '\' is replaced with '/' due to differencies on Windows and Mac OS.
...
#line $lineno "$filename (autosplit into $fixed_path)"
EOT
	    print $out @cache;
	    @cache = ();
	    $caching = 0;
